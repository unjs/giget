...
describe("gitlab provider", () => {
  ...
  it("simple repo", () => {
    const result = gitlab("org/repo", opts)!;
  ...
  it("repo with ref", () => {
    const result = gitlab("org/repo#v1.0", opts)!;
  ...
  it("subgroup repo", () => {
    const result = gitlab("group/subgroup/project", opts)!;
  ...
  it("deeply nested subgroup", () => {
    const result = gitlab("group/sub1/sub2/project#develop", opts)!;
  ...
  it("subgroup with :: subdir", () => {
    const result = gitlab("group/subgroup/project::src/template", opts)!;
    expect(result.tar).toBe("https://gitlab.com/group/subgroup/project/-/archive/main.tar.gz");
  ...
  it("subgroup with :: subdir and ref", () => {
    const result = gitlab("group/subgroup/project::src/template#v2.0", opts)!;
